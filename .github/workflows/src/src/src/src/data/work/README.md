...
Master password: `gyanendra@#&5009` (change it in Worker environment variables).

## 📁 Project Structure
## 📡 Features
- **Live Ticker** – NEPSE, S&P500, Bitcoin, Gold, USD/NPR
- **Fear & Greed Nepal™** – Proprietary 7-component index
- **Technical Indicators** – RSI, MACD, Bollinger, VWAP, Fibonacci, Pivots
- **AI Pattern Scanner** – Candlestick patterns (Doji, Hammer, etc.)
- **Gemini AI Prediction** – Market commentary every half an hour
- **Telegram & Facebook Broadcasting** – One-click admin broadcasts

## 🔒 License
Proprietary – NEPSE HOURS™
